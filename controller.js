...
/*campus*/		//_app.u.loadScript(_app.rq[i][3],callback,(_app.rq[i]));
...
/*campus apptimize*/	if(infoObj.state == 'complete'){
/*campus apptimize*/		_app.ext.quickstart.vars.showContentCompleteFired = true;
/*campus apptimize*/		}
						}
					else	{
